...
<body>
  ...
  <?php 
		...
		$M1= $_POST['manager'];
		$stid = oci_parse($conn,"SELECT PLAYER.PLAYERID,PLAYER.NAME,PLAYER.AGE,PLAYER.COUNTRY,PLAYER.OVERALL,PLAYER.TEAMID,MANAGER.NAME FROM PLAYER,MANAGER WHERE PLAYER.TEAMID=MANAGER.TEAMID AND MANAGERID='$M1'");
		oci_execute($stid);
		$flag=0;
